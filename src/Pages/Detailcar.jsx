...
import { Fuel, Calendar, Settings, Users, Award, ThumbsUp } from 'lucide-react';
...
const CarDetail = () => {
  ...
  // Function to process features from the database
  const processFeatures = (featuresString) => {
    if (!featuresString) return [];
    // Split by both commas and hyphens, then clean up the results
          ...
          <div className="md:grid md:grid-cols-2 gap-0">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="border-t pt-6">
                <div className="text-sm font-medium text-gray-500 mb-2">Quick Overview</div>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>{car.capacity || '5'} Seats</span>
                  </div>
                </div>
              </div>
            </div>
