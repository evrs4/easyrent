...
const NyobaLagi = () => {
  ...
  const slides = [
    {
      img: satu,
      title: "✨ Discover Your Perfect Ride with 40+ Cars to Choose From ✨",
      description:
        "Looking for the ideal car for your next journey? Our rental service offers a wide range of over 40 vehicles, from sleek sedans to spacious SUVs and magnificent rides. Whether you're planning a business trip or a weekend getaway!",
    },
    {
      img: dua,
